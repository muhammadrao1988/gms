...
class Login extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->dummyEmail = "muhammadrao1988@gmail.com";
            ...
            if($response['success'] == false){
                ...
                if ($user_id == "") {
					...
					$message = 'Hi,<br><br>
								...
								Username: '.$username.'
								<br/>
								Account Name: '.$this->m_login->account_name($parent_child).'
								<br/>
								Parent: '.$this->m_login->account_name($parent).'
								<br/>
								<br/>
								Thanks,<br>
								Mintbrains';
                    ...
                    if($status==2 || $status==0){
                        redirect(ADMIN_DIR . 'login/forget_pass/?error=You can not reset your password because your account is disabled.');
                    }else {
