...
<section id="main-content" class="inner-main-pages">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo site_url(ADMIN_DIR . "subscription"); ?>">Subscription</a></li>
        ...
        <div class="row page-top-btn">
            <div class="btn-row">
                <div class="btn-group">
                    ...
                    <button class="btn btn-white active" type="button">Subscription</button>
                    <span class="vert-sep"></span>
                </div>
            </div>
            <div class="clearfix"></div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <section class="panel">
                <header class="panel-heading theme-panel-heading"><strong>Subscription - Form</strong></header>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="Name" class="col-lg-3 col-sm-3 control-label">Subscription
                                        Name</label>
                                    <div class="col-lg-6">
