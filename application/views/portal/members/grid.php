    ...
    <section class="wrapper">
        ...
        <div class="row page-table">
            <div class="clearfix"></div>
                ...
                $grid->hide_fields = array('machine_serial','status','invoices_id',(($this->session->userdata('user_info')->is_machine == 1)?'acc_id':'machine_member_id'),'day_invoice');
                ...
                $grid->custom_col_name_fields = array('machine_member_id'=>'Member ID','monthly_status'=>'Membership Status','acc_name'=>'Name','acc_tel'=>'Mobile','name'=>'Subscription','acc_date'=>'Datetime','acc_id'=>'account_id');
