...
<header class="header fixed-top clearfix">
    ...
    <div class="brand">
        ...
        <a href="<?php echo site_url(ADMIN_DIR . "dashboard"); ?>" class="logo"> <img
                    src="<?php echo base_url('assets/images/logo.png') ?>" alt="<?php echo ADMIN_TITLE; ?>"></a>
    ...
    <?php if (sessionVar('switch_customer') != "") {
      ...
      position: absolute;
          right: 100px;
      margin-top: 5px;
      text-align: center;"> You are currently viewing the account "<?php echo $accc_name->acc_name; ?>" <br><a
                    href="<?php echo site_url(ADMIN_DIR . "my_numbers_reports/returnAccount"); ?>"> Click here </a> to
            return your account
        </div>
    <?php } ?>
    <!--logo end-->
