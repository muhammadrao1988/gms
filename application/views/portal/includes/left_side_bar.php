...
$user_info_left = $this->db->query("SELECT t1.first_name, t1.surname, t2.acc_name FROM users t1, accounts t2 WHERE t1.user_id = '".$this->session->userdata['user_id']."' AND t1.parent_child = t2.acc_id")->result();
