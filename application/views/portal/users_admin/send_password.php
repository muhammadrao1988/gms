        ...
        <div class="row page-top-btn">
            <div class="btn-row">
                <div class="btn-group">
                    ...
                    <button class="btn btn-white" data-action="<?= site_url(ADMIN_DIR . "users_admin/form/" . $id); ?>"
                            type="button">Users
                    </button>
                    <span class="vert-sep"></span>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <form id="validate" class="form-horizontal theme-form-horizontal"
                          action="<?= site_url(ADMIN_DIR . $this->module_name . '/send_new_password'); ?>" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="password" id="password" name="password" value=""
                                               class="form-control validate[required,custom[my_password]]">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-3 control-label">Re-Type New
                                        Password:</label>
                                    <div class="col-lg-4">
                                ...
                                if ($login_status == 3) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <p class="help-block">Note: If you change password the user account will be
                                                unlock.</p>
                                        </div>
                                    </div>
                                    <input type="hidden">
