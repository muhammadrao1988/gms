...
<section id="main-content" class="inner-main-pages">
    <section class="wrapper">
        ...
        <div class="row page-table">
            ...
            $grid->search_fields_html = array('unpaid_invoice'=>$monthly_sttaus,'check_type'=>$check_type,'datetime'=>$datetime,'subscription_status'=>$subsction_status);
            $grid->custom_func = array('unpaid_invoice'=>'getPaymemntStatus','subscription_status'=>'getSubscriptionStatusResult','datetime'=>'grid_dateTimeFormat');
            $grid->custom_col_name_fields = array('acc_name'=>'member_name','Name'=>'membership_type','machine_member_id'=>'member ID','acc_id'=>'account_id','datetime'=>'Date','unpaid_invoice'=>'fees_status');
